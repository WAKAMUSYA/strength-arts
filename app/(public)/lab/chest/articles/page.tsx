...
function ArticlesContent() {
  ...
  const filteredArticles = CHEST_ARTICLES.filter(art => {
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <div className="flex items-center justify-between text-[10px] font-mono text-zinc-500 border-b border-zinc-900/60 pb-3">
                <span className="uppercase tracking-widest text-red-450 font-extrabold flex items-center gap-1">
...
export default function ChestArticlesPage() {
  return (
    <main className="min-h-screen bg-black text-white selection:bg-red-900 selection:text-white pb-32">
      ...
      <nav className="border-b border-zinc-900 bg-zinc-950/40 backdrop-blur-md sticky top-16 z-30 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <Link 
            href="/lab/chest" 
            className="text-xs font-mono font-bold text-zinc-500 hover:text-red-450 transition-colors inline-flex items-center gap-1 cursor-pointer"
          >
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] text-zinc-550 font-mono hidden sm:inline">SA-CH-LECTURES</span>
          </div>
        </div>
      </nav>
      ...
      <header className="max-w-6xl mx-auto px-6 pt-16 pb-8 text-center space-y-4">
        <h1 className="text-3xl md:text-5xl font-black tracking-tight text-white">
          胸トレ研究所<br className="sm:hidden" /> コラムアーカイブ
        </h1>
      </header>
