...
export default async function LegArticleDetail({ params }: { params: { slug: string } }) {
  const { slug } = params
      ...
      <div className="max-w-4xl mx-auto px-6 mt-16">
        <div className="flex justify-center mb-12">
          <Link 
            ...
            className="px-8 py-4 rounded-full bg-zinc-900 hover:bg-amber-950/50 border border-zinc-800 hover:border-amber-900 text-sm font-bold text-zinc-300 hover:text-amber-400 transition-all flex items-center gap-2"
          >
