...
import DashboardCptLectureList from '@/components/DashboardCptLectureList';
...
export default function DashboardAcademyPage() {
  const cptBlocks = Array.from(new Set(cptQuestions.map((q) => q.blockId))).sort((a, b) => a - b);
    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="mt-16">
        <div className="flex items-center space-x-3 mb-8">
          <h2 className="text-2xl font-bold text-slate-900">CPT基礎理論</h2>
          <span className="text-sm font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-full">CPT対策</span>
        </div>
